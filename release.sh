#!/usr/bin/env bash
# release.sh — interactive release driver for markdown-paste.
...
DOWNLOAD_URL_BASE="https://github.com/martin-papy/markdown-paste/releases/download"
...
main() {
  ...
  log "Actions: https://github.com/martin-papy/markdown-paste/actions"
  log "Release (when workflow finishes): https://github.com/martin-papy/markdown-paste/releases/tag/v${TARGET}"
}
